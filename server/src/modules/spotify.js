...
NewSpotifyApi.prototype._buildRequest = function (method, endpoint, data = {}, authorized = false, accessToken = null, externalURL = false) {
...
NewSpotifyApi.prototype._sendRequest = function (method, endpoint, data = {}, authorized = false, accessToken, externalURL = false) {
  const options = this._buildRequest(method, endpoint, data, authorized, accessToken, externalURL)

  return (axios(options))
}

NewSpotifyApi.prototype.generateAccessToken = function (reqType = null) {
...
NewSpotifyApi.prototype.getPlaylists = function (limit = _limit, offset = 0) {
...
NewSpotifyApi.prototype.getTracksFromPlaylist = function (
    playlistId,
    limit,
    offset
    //duplicates = false
...
NewSpotifyApi.prototype._getAllNextItems = async function (funcName) {
...
NewSpotifyApi.prototype._getTracks = async function (limit = this._limit, offset = 0) {
  return this._sendRequest(
      'GET',
...
NewSpotifyApi.prototype.authorize = async function (username, scope, redirectURI) {
...
NewSpotifyApi.prototype.getSongCountFromPlaylists = async function () {
  // includes duplicates
...
NewSpotifyApi.prototype.setCredentials = function (uid, un, up) {
  this._userId = uid
  this._username = un
  this._userPassword = up
};

NewSpotifyApi.prototype.getCredentials = function () {
...
NewSpotifyApi.prototype.getAccessToken = function () {
  return this._accessToken
};

NewSpotifyApi.prototype.setAccessToken = function (accessToken) {
  this._accessToken = accessToken;
};

NewSpotifyApi.prototype.getRefreshToken = function () {
  return localStorage.getItem('refreshToken')
  //return this._refreshToken
};

NewSpotifyApi.prototype.setRefreshToken = function (refreshToken) {
  //this._refreshToken = refreshToken;
  localStorage.setItem('refreshToken', refreshToken)
};

NewSpotifyApi.prototype.getAuthorizedCode = function () {
...
NewSpotifyApi.prototype.setAuthorizedCode = function (code) {
  //this._authorizedAccessToken = localStorage.getItem('SpotifyAuthCode');
  //return this._authorizedAccessToken
  return localStorage.setItem('SpotifyAuthCode', code)
};

NewSpotifyApi.prototype.getAuthorizedAccessToken = function () {
  return localStorage.getItem('authorizedAccessToken')
  //return this._authorizedAccessToken
};

NewSpotifyApi.prototype.setAuthorizedAccessToken = function (authorizedAccessToken) {
  //this._authorizedAccessToken = localStorage.getItem('SpotifyAuthCode');
